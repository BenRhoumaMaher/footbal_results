...
<div class="container-lg main">
    ...
    <div class="row mt-4">
        ...
        <?php endforeach; ?>
        <?php else : ?>
        <h3 class="text-center">There's no match today </h3>
        <div class="text-center">
            <form method="GET" action="yesterday.php">
                <input type="submit" value="Yesterday" name="" class="btn btn-primary my-2">
            </form>
            <form method="GET" action="tomorrow.php">
                <input type="submit" value="Tomorrow" name="" class="btn btn-primary my-2">
            </form>
        </div>
        <?php endif; ?>
    </div>
